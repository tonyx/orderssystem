...
-- ALTER TABLE public.archivedorderslogbuffer OWNER TO "onyx";
...
SELECT pg_catalog.setval('public.archivedorderslog_id_seq', 252, true);
...
252	2019-02-12 18:57:13.153153	558
\.
...
SELECT pg_catalog.setval('public.incredientdecrementid_seq', 247, true);
...
1319	249	1	558		6.00	6	\N	2019-02-05 11:40:25.81386	\N	452	f	0	f	1
...
SELECT pg_catalog.setval('public.orderitems_orderitemid_seq', 1350, true);
...
SELECT pg_catalog.setval('public.orderitemstates_orderitemstates_id_seq', 2536, true);
...
SELECT pg_catalog.setval('public.orderoutgroup_id_seq', 473, true);
...
558	1		t	2	2019-02-05 11:40:09.69531	2019-02-12 18:57:13.147118	f	t	12.00	12.00	0.00	0.00	f	f	\N
552	9		f	2	2019-02-05 10:12:22.238204	2019-02-05 10:23:53.50884	f	t	12.00	12.00	0.00	0.00	f	f	\N
559	1		t	2	2019-02-05 12:50:29.973913	2019-02-12 15:57:51.400517	f	f	6.00	6.00	0.00	0.00	f	f	\N
...
567	2		t	2	2019-02-09 16:04:15.740133	2019-02-12 15:57:52.439809	f	f	6.00	6.00	0.00	0.00	f	f	\N
...
SELECT pg_catalog.setval('public.orders_orderid_seq', 570, true);
...
SELECT pg_catalog.setval('public.paymentid_seq', 46, true);
...
290	567	6.00	\N	f	2019-02-09 16:20:56.8392	\N
...
SELECT pg_catalog.setval('public.suborderid_seq', 294, true);
