...
CREATE TABLE public.invoices (
    ...
    invoicedata timestamp without time zone NOT NULL,
    suborderid int,
    orderid int
);
...
ALTER TABLE ONLY public.invoices
    ADD CONSTRAINT invoice_customer_fk FOREIGN KEY (customerdataid) REFERENCES public.customerdata(categoryid) MATCH FULL;
...
53	115	1.00	f	f	3.00	3.00
9	117	10.00	f	f	0.50	0.50
55	139	2.00	t	t	4.00	4.00
\.
...
SELECT pg_catalog.setval('public.ingredientpriceid_seq', 55, true);
...
1023	245	1	447		5.00	6	\N	2018-09-28 11:20:58.448784	2018-09-28 16:04:53.23715	249	f	193	t	0
...
1033	196	1	449		8.00	1	\N	2018-10-07 20:35:41.536191	\N	248	f	\N	f	0
1027	245	1	447		5.00	6	\N	2018-09-28 12:54:01.22954	2018-09-28 17:43:55.426116	243	f	0	f	0
1024	245	1	447	bla	5.00	6	\N	2018-09-28 11:30:33.416479	2018-09-28 17:43:53.020992	249	f	192	t	0
1034	245	1	449		7.00	1	\N	2018-10-08 11:18:33.150386	\N	248	f	\N	f	0
\.
...
SELECT pg_catalog.setval('public.orderitems_orderitemid_seq', 1034, true);
...
1982	1033	1	2018-10-07 20:35:41.536191
1983	1034	1	2018-10-08 11:18:33.150386
\.
...
SELECT pg_catalog.setval('public.orderitemstates_orderitemstates_id_seq', 1983, true);
...
SELECT pg_catalog.setval('public.orderoutgroup_id_seq', 249, true);
...
449	3		t	2	2018-10-07 20:35:32.031313	\N	f	f	0.00	0.00	0.00	0.00	f	f	\N
447	1		t	2	2018-09-28 11:20:49.881203	\N	t	f	36.50	32.85	0.00	-10.00	t	f	\N
\.
...
SELECT pg_catalog.setval('public.orders_orderid_seq', 449, true);
...
192	447	5.00	\N	f	2018-10-08 10:03:47.08989
193	447	7.00	\N	f	2018-10-08 11:38:55.425044
\.
...
SELECT pg_catalog.setval('public.suborderid_seq', 193, true);
...
SELECT pg_catalog.setval('public.voidedorderslog_id_seq', 217, true);
